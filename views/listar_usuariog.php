                ...
                <div class="main-content">
                    ...
                    switch (@$_REQUEST["page"]) {
                        case "novo":
                            ...
                            break;
                        case "listar";
                            include("listar_usuariog.php");
                            break;
                        case "salvar";
                            include("salvar_usuariog.php");
                            break;
                        case "editar";
                            include("editar_usuariog.php");
                            break;
                    }
                    ...
                    if ($qtd > 0) {
                        ...
                        while ($row = $res->fetch_object()) {
                            ...
                            print "<td>
                   <button onclick=\"location.href='editar_usuariog.php?id=$row->id';\" class='btn btn-success'>Editar</button> 
